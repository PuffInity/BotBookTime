...
export const MASTER_PANEL_ACTION = {
  ...
  OPEN_PROFILE_EDIT_DISPLAY_NAME: 'master-panel:open-profile:edit:display-name',
  OPEN_PROFILE_EDIT_STARTED_ON: 'master-panel:open-profile:edit:started-on',
  OPEN_PROFILE_EDIT_PROCEDURES_DONE_TOTAL: 'master-panel:open-profile:edit:procedures-done-total',
