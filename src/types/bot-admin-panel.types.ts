...
export const ADMIN_PANEL_ACTION = {
  ...
  MASTERS_DELETE_OPEN: 'admin-panel:masters:delete:open',
  MASTERS_DELETE_CONFIRM: 'admin-panel:masters:delete:confirm',
  MASTERS_DELETE_CANCEL: 'admin-panel:masters:delete:cancel',
  ...
  SERVICES_CREATE_OPEN: 'admin-panel:services:create:open',
  SERVICES_CREATE_CANCEL: 'admin-panel:services:create:cancel',
  SERVICES_CREATE_STEP_ADD_ANOTHER: 'admin-panel:services:create:step:add-another',
  SERVICES_CREATE_STEP_CONTINUE: 'admin-panel:services:create:step:continue',
  SERVICES_CREATE_GUARANTEE_ADD_ANOTHER: 'admin-panel:services:create:guarantee:add-another',
  SERVICES_CREATE_GUARANTEE_CONTINUE: 'admin-panel:services:create:guarantee:continue',
  SERVICES_CREATE_CONFIRM: 'admin-panel:services:create:confirm',
  ...
  SERVICES_EDIT_STEP_DESCRIPTION_OPEN: 'admin-panel:services:edit:step-description:open',
  SERVICES_EDIT_STEP_DURATION_OPEN: 'admin-panel:services:edit:step-duration:open',
...
export const ADMIN_PANEL_BUTTON_TEXT = {
  ...
  SCHEDULE_MARK_DAY_OFF: '🚫 Зробити вихідним',
  ...
  MASTERS_CREATE_BACK_TO_SCHEDULE: '⬅️ До графіку',
  MASTERS_CREATE_MARK_DAY_OFF: '🚫 Зробити вихідним',
  ...
  MASTERS_DELETE_OPEN: '❌ Видалити майстра',
  MASTERS_DELETE_CONFIRM: '🗑 Так, видалити майстра',
  MASTERS_DELETE_CANCEL: '❌ Скасувати видалення',
  ...
  SERVICES: '💼 Послуги',
  SERVICES_CREATE: '➕ Створити нову послугу',
  SERVICES_CREATE_ADD_ANOTHER: '➕ Додати ще',
  SERVICES_CREATE_CONTINUE: '➡️ Продовжити',
  SERVICES_CREATE_CANCEL: '❌ Скасувати створення',
  SERVICES_CREATE_CONFIRM: '✅ Підтвердити створення',
  ...
  SERVICES_EDIT_STEP_DESCRIPTION: '📝 Змінити опис етапу',
  SERVICES_EDIT_STEP_DURATION: '⏱ Змінити час етапу',
  ...
  SETTINGS_NOTIFICATIONS_ALL_ON: '🔄 Увімкнути всі',
  SETTINGS_NOTIFICATIONS_ALL_OFF: '🔕 Вимкнути всі',
