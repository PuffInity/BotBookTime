...
// uk: Flow/UI константа PROFILE_NAME_SCENE_ID / en: Flow/UI constant PROFILE_NAME_SCENE_ID / cz: Flow/UI konstanta PROFILE_NAME_SCENE_ID
export const PROFILE_NAME_SCENE_ID = 'profile-name-scene';

// uk: Flow/UI константа MAX_INVALID_NAME_ATTEMPTS / en: Flow/UI constant MAX_INVALID_NAME_ATTEMPTS / cz: Flow/UI konstanta MAX_INVALID_NAME_ATTEMPTS
...
/**
 * uk: Публічна flow-функція createProfileNameScene.
 * en: Public flow function createProfileNameScene.
 * cz: Veřejná flow funkce createProfileNameScene.
 */
