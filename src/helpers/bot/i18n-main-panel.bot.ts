...
export const MAIN_PANEL_DICTIONARY = {
  uk: {
    ...
    BOOKING_EMAIL_SENT: "📧 Ми надіслали лист на ваш email: запис створено і очікує підтвердження.\nПісля підтвердження майстром ви отримаєте ще один лист.",
    ...
    OTP_EMAIL_CODE_SENT: "✉️ Код підтвердження відправлено.\nEmail: {email}\n\nВведіть 6-значний код із листа.\nКод дійсний 5 хвилин.",
    ...
    OTP_EMAIL_MAILER_NOT_CONFIGURED: "⚙️ Сервіс email тимчасово не налаштований.\nЗверніться до адміністратора або спробуйте пізніше.",
    ...
    OTP_PHONE_ALREADY_VERIFIED: "✅ Номер телефону вже підтверджено.",
    OTP_PHONE_BLOCKED: "⛔ Забагато невірних спроб. Спробуйте знову через 30 хвилин.",
    OTP_PHONE_CANCELLED: "❌ Підтвердження номера телефону скасовано.",
    OTP_PHONE_CODE_SENT: "📲 SMS-код підтвердження відправлено на номер {phone}.\n\nВведіть 6-значний код із SMS.\nКод дійсний 5 хвилин.",
    OTP_PHONE_EXPIRED: "⌛ Термін дії коду завершився. Надішліть код повторно.",
    OTP_PHONE_INVALID_CODE: "⚠️ Невірний OTP код. Перевірте SMS і спробуйте ще раз.",
    OTP_PHONE_MISSING: "⚠️ Номер телефону не вказано. Спочатку додайте номер у профілі.",
    OTP_PHONE_RESEND_COOLDOWN: "⏱ Повторна відправка буде доступна через {seconds} сек.",
    OTP_PHONE_SEND_FAILED: "⚠️ Не вдалося відправити SMS-код. Спробуйте ще раз пізніше.",
    OTP_PHONE_SMS_NOT_CONFIGURED: "⚠️ Функція підтвердження номера телефону тимчасово недоступна. Спробуйте пізніше.",
    OTP_PHONE_VERIFIED: "✅ Номер телефону підтверджено успішно.\nПідтверджений номер: {phone}",
    ...
    PROFILE_BOOKING_ACTION_STUB: "Цю дію вже винесено в окремий етап.\nНа наступному кроці підключимо повну робочу реалізацію.",
    ...
    MAIN_PANEL_MSG_INVALID_BOOKING_STATUS_CALLBACK: "Некоректна callback-дія для статусу бронювання",
    ...
    PROFILE_NOTIFICATION_DELIVERY: "Telegram-сповіщення надходять завжди, якщо тип увімкнений.\nEmail/SMS надходять лише для підтверджених контактів.",
    ...
    PROFILE_PHONE_NOT_VERIFIED_UNAVAILABLE: "⚪ не підтверджено (функція недоступна)",
    PROFILE_PHONE_ADD_PROMPT: "➕ Додати телефон\n\nВведіть номер телефону у форматі +420123456789.",
    PROFILE_PHONE_ADD_CANCELLED: "❌ Додавання телефону скасовано.",
    PROFILE_PHONE_ADDED_TITLE: "✅ Телефон успішно збережено.",
    PROFILE_PHONE_ADDED_VALUE: "Телефон",
    PROFILE_PHONE_ADDED_HINT: "Після зміни номера його потрібно підтвердити повторно.",
    PROFILE_PHONE_ALREADY_USED: "⚠️ Цей номер вже використовується іншим користувачем.",
    PROFILE_PHONE_INVALID: "⚠️ Некоректний формат телефону. Використовуйте формат +420123456789.",
    PROFILE_STUB_BODY: "Цей розділ вже зарезервований у логіці, зараз тимчасово працює як заглушка.\nНа наступному етапі підключимо повну робочу реалізацію.",
    PROFILE_TELEGRAM: "💬 Telegram",
    PROFILE_TITLE: "👤 Профіль клієнта",
    PROFILE_VERIFY_EMAIL: "✅ Підтвердити email",
    PROFILE_VERIFY_PHONE: "✅ Підтвердити номер телефона",
    PROFILE_VERIFY_PHONE_DISABLED: "✅ Підтвердити номер (Недоступно)",
  ...
  en: {
    ...
    BOOKING_EMAIL_SENT: "📧 We sent an email: your booking is created and waiting for confirmation.\nAfter master confirmation you will get one more email.",
    ...
    OTP_PHONE_ALREADY_VERIFIED: "✅ Phone number is already verified.",
    OTP_PHONE_BLOCKED: "⛔ Too many invalid attempts. Try again in 30 minutes.",
    OTP_PHONE_CANCELLED: "❌ Phone verification canceled.",
    OTP_PHONE_CODE_SENT: "📲 SMS verification code sent to {phone}.\n\nEnter the 6-digit code from SMS.\nThe code is valid for 5 minutes.",
    OTP_PHONE_EXPIRED: "⌛ The code has expired. Please resend it.",
    OTP_PHONE_INVALID_CODE: "⚠️ Invalid OTP code. Check SMS and try again.",
    OTP_PHONE_MISSING: "⚠️ Phone number is missing. Add phone in profile first.",
    OTP_PHONE_RESEND_COOLDOWN: "⏱ Resend will be available in {seconds} sec.",
    OTP_PHONE_SEND_FAILED: "⚠️ Failed to send SMS code. Please try again later.",
    OTP_PHONE_SMS_NOT_CONFIGURED: "⚠️ Phone number verification is temporarily unavailable. Please try again later.",
    OTP_PHONE_VERIFIED: "✅ Phone number verified successfully.\nVerified number: {phone}",
    ...
    PROFILE_BOOKING_ACTION_STUB: "This action is already separated into a dedicated step.\nA full implementation will be connected in the next phase.",
    ...
    MAIN_PANEL_MSG_INVALID_BOOKING_STATUS_CALLBACK: "Invalid callback action for booking status",
    ...
    PROFILE_NOTIFICATION_DELIVERY: "Telegram notifications are sent whenever the type is enabled.\nEmail/SMS are sent only for verified contacts.",
    ...
    PROFILE_PHONE: "📱 Phone",
    PROFILE_PHONE_NOT_VERIFIED_UNAVAILABLE: "⚪ not verified (feature unavailable)",
    PROFILE_PHONE_ADD_PROMPT: "➕ Add phone\n\nEnter phone number in format +420123456789.",
    PROFILE_PHONE_ADD_CANCELLED: "❌ Phone adding canceled.",
    PROFILE_PHONE_ADDED_TITLE: "✅ Phone saved successfully.",
    PROFILE_PHONE_ADDED_VALUE: "Phone",
    PROFILE_PHONE_ADDED_HINT: "After changing phone, verification must be completed again.",
    PROFILE_PHONE_ALREADY_USED: "⚠️ This phone number is already used by another user.",
    PROFILE_PHONE_INVALID: "⚠️ Invalid phone format. Use +420123456789.",
    PROFILE_STUB_BODY: "This section is already reserved in the flow and currently works as a placeholder.\nWe will connect full implementation in the next step.",
    PROFILE_TELEGRAM: "💬 Telegram",
    PROFILE_TITLE: "👤 Client Profile",
    PROFILE_VERIFY_EMAIL: "✅ Verify email",
    PROFILE_VERIFY_PHONE: "✅ Verify phone number",
    PROFILE_VERIFY_PHONE_DISABLED: "✅ Verify phone (Unavailable)",
  ...
  cs: {
    ...
    BOOKING_EMAIL_SENT: "📧 Poslali jsme email: rezervace je vytvořena a čeká na potvrzení.\nPo potvrzení mistrem dostanete další email.",
    ...
    OTP_EMAIL_MAILER_NOT_CONFIGURED: "⚙️ Email služba dočasně není nakonfigurovaná.\nKontaktujte administrátora nebo to zkuste později.",
    ...
    OTP_PHONE_ALREADY_VERIFIED: "✅ Telefonní číslo je už ověřené.",
    OTP_PHONE_BLOCKED: "⛔ Příliš mnoho neplatných pokusů. Zkuste to znovu za 30 minut.",
    OTP_PHONE_CANCELLED: "❌ Ověření telefonního čísla bylo zrušeno.",
    OTP_PHONE_CODE_SENT: "📲 SMS ověřovací kód byl odeslán na číslo {phone}.\n\nZadejte 6místný kód ze SMS.\nKód je platný 5 minut.",
    OTP_PHONE_EXPIRED: "⌛ Platnost kódu vypršela. Odešlete kód znovu.",
    OTP_PHONE_INVALID_CODE: "⚠️ Neplatný OTP kód. Zkontrolujte SMS a zkuste to znovu.",
    OTP_PHONE_MISSING: "⚠️ Telefonní číslo není uvedeno. Nejprve jej přidejte v profilu.",
    OTP_PHONE_RESEND_COOLDOWN: "⏱ Opětovné odeslání bude dostupné za {seconds} s.",
    OTP_PHONE_SEND_FAILED: "⚠️ Nepodařilo se odeslat SMS kód. Zkuste to znovu později.",
    OTP_PHONE_SMS_NOT_CONFIGURED: "⚠️ Ověření telefonního čísla je dočasně nedostupné. Zkuste to prosím později.",
    OTP_PHONE_VERIFIED: "✅ Telefonní číslo bylo úspěšně ověřeno.\nOvěřené číslo: {phone}",
    ...
    PROFILE_BOOKING_ACTION_STUB: "Tato akce je už oddělena do samostatného kroku.\nPlnou implementaci připojíme v další fázi.",
    ...
    MAIN_PANEL_MSG_INVALID_BOOKING_STATUS_CALLBACK: "Neplatná callback akce pro stav rezervace",
    ...
    PROFILE_NOTIFICATION_DELIVERY: "Telegram oznámení chodí vždy, když je typ zapnutý.\nEmail/SMS chodí jen pro ověřené kontakty.",
    ...
    PROFILE_PHONE_NOT_VERIFIED_UNAVAILABLE: "⚪ neověřeno (funkce nedostupná)",
    PROFILE_PHONE_ADD_PROMPT: "➕ Přidat telefon\n\nZadejte telefonní číslo ve formátu +420123456789.",
    PROFILE_PHONE_ADD_CANCELLED: "❌ Přidání telefonu bylo zrušeno.",
    PROFILE_PHONE_ADDED_TITLE: "✅ Telefon byl úspěšně uložen.",
    PROFILE_PHONE_ADDED_VALUE: "Telefon",
    PROFILE_PHONE_ADDED_HINT: "Po změně čísla je potřeba znovu provést ověření.",
    PROFILE_PHONE_ALREADY_USED: "⚠️ Toto číslo už používá jiný uživatel.",
    PROFILE_PHONE_INVALID: "⚠️ Neplatný formát telefonu. Použijte +420123456789.",
    PROFILE_STUB_BODY: "Tato sekce je už rezervována v logice a aktuálně funguje jako dočasná zástupka.\nPlnou implementaci připojíme v dalším kroku.",
    PROFILE_TELEGRAM: "💬 Telegram",
    PROFILE_TITLE: "👤 Profil klienta",
    PROFILE_VERIFY_EMAIL: "✅ Ověřit email",
    PROFILE_VERIFY_PHONE: "✅ Ověřit telefonní číslo",
    PROFILE_VERIFY_PHONE_DISABLED: "✅ Ověřit telefon (Nedostupné)",
